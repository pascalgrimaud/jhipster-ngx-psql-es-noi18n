...
public class FieldTestMapstructEntityResourceIntTest {
     ...
     *
     * @see com.mycompany.myapp.repository.search.FieldTestMapstructEntitySearchRepositoryMockConfiguration
     */
    @Autowired
    private FieldTestMapstructEntitySearchRepository mockFieldTestMapstructEntitySearchRepository;
    ...
    public void createFieldTestMapstructEntity() throws Exception {
        ...
        verify(mockFieldTestMapstructEntitySearchRepository, times(1)).save(testFieldTestMapstructEntity);
    }
    ...
    public void createFieldTestMapstructEntityWithExistingId() throws Exception {
        ...
        // Validate the FieldTestMapstructEntity in Elasticsearch
        verify(mockFieldTestMapstructEntitySearchRepository, times(0)).save(fieldTestMapstructEntity);
    }
    ...
    public void deleteFieldTestMapstructEntity() throws Exception {
        ...
        // Validate the FieldTestMapstructEntity in Elasticsearch
        verify(mockFieldTestMapstructEntitySearchRepository, times(1)).deleteById(fieldTestMapstructEntity.getId());
    }
    ...
    public void searchFieldTestMapstructEntity() throws Exception {
        // Initialize the database
        fieldTestMapstructEntityRepository.saveAndFlush(fieldTestMapstructEntity);
        when(mockFieldTestMapstructEntitySearchRepository.search(queryStringQuery("id:" + fieldTestMapstructEntity.getId())))
            .thenReturn(Collections.singletonList(fieldTestMapstructEntity));
