...
public class FieldTestPagerEntityResourceIntTest {
     ...
     *
     * @see com.mycompany.myapp.repository.search.FieldTestPagerEntitySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final FieldTestPagerEntityResource fieldTestPagerEntityResource = new FieldTestPagerEntityResource(fieldTestPagerEntityRepository, mockFieldTestPagerEntitySearchRepository);
    ...
    public void createFieldTestPagerEntity() throws Exception {
        ...
        verify(mockFieldTestPagerEntitySearchRepository, times(1)).save(testFieldTestPagerEntity);
    }
    ...
    public void createFieldTestPagerEntityWithExistingId() throws Exception {
        ...
        // Validate the FieldTestPagerEntity in Elasticsearch
        verify(mockFieldTestPagerEntitySearchRepository, times(0)).save(fieldTestPagerEntity);
    }
    ...
    public void deleteFieldTestPagerEntity() throws Exception {
        ...
        // Validate the FieldTestPagerEntity in Elasticsearch
        verify(mockFieldTestPagerEntitySearchRepository, times(1)).deleteById(fieldTestPagerEntity.getId());
    }
    ...
    public void searchFieldTestPagerEntity() throws Exception {
        // Initialize the database
        fieldTestPagerEntityRepository.saveAndFlush(fieldTestPagerEntity);
        when(mockFieldTestPagerEntitySearchRepository.search(queryStringQuery("id:" + fieldTestPagerEntity.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(fieldTestPagerEntity), PageRequest.of(0, 1), 1));
