...
public class DivisionResourceIntTest {
     ...
     *
     * @see com.mycompany.myapp.repository.search.DivisionSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final DivisionResource divisionResource = new DivisionResource(divisionRepository, mockDivisionSearchRepository);
