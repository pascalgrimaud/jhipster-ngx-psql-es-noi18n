...
public class EntityWithServiceClassAndDTOResourceIntTest {
     ...
     *
     * @see com.mycompany.myapp.repository.search.EntityWithServiceClassAndDTOSearchRepositoryMockConfiguration
     */
    @Autowired
    private EntityWithServiceClassAndDTOSearchRepository mockEntityWithServiceClassAndDTOSearchRepository;
    ...
    public void createEntityWithServiceClassAndDTO() throws Exception {
        ...
        verify(mockEntityWithServiceClassAndDTOSearchRepository, times(1)).save(testEntityWithServiceClassAndDTO);
    }
    ...
    public void createEntityWithServiceClassAndDTOWithExistingId() throws Exception {
        ...
        // Validate the EntityWithServiceClassAndDTO in Elasticsearch
        verify(mockEntityWithServiceClassAndDTOSearchRepository, times(0)).save(entityWithServiceClassAndDTO);
    }
    ...
    public void deleteEntityWithServiceClassAndDTO() throws Exception {
        ...
        // Validate the EntityWithServiceClassAndDTO in Elasticsearch
        verify(mockEntityWithServiceClassAndDTOSearchRepository, times(1)).deleteById(entityWithServiceClassAndDTO.getId());
    }
    ...
    public void searchEntityWithServiceClassAndDTO() throws Exception {
        // Initialize the database
        entityWithServiceClassAndDTORepository.saveAndFlush(entityWithServiceClassAndDTO);
        when(mockEntityWithServiceClassAndDTOSearchRepository.search(queryStringQuery("id:" + entityWithServiceClassAndDTO.getId())))
            .thenReturn(Collections.singletonList(entityWithServiceClassAndDTO));
