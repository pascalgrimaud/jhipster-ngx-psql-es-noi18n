...
public class FieldTestPaginationEntityResourceIntTest {
     ...
     *
     * @see com.mycompany.myapp.repository.search.FieldTestPaginationEntitySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final FieldTestPaginationEntityResource fieldTestPaginationEntityResource = new FieldTestPaginationEntityResource(fieldTestPaginationEntityRepository, mockFieldTestPaginationEntitySearchRepository);
    ...
    public void createFieldTestPaginationEntity() throws Exception {
        ...
        verify(mockFieldTestPaginationEntitySearchRepository, times(1)).save(testFieldTestPaginationEntity);
    }
    ...
    public void createFieldTestPaginationEntityWithExistingId() throws Exception {
        ...
        // Validate the FieldTestPaginationEntity in Elasticsearch
        verify(mockFieldTestPaginationEntitySearchRepository, times(0)).save(fieldTestPaginationEntity);
    }
    ...
    public void deleteFieldTestPaginationEntity() throws Exception {
        ...
        // Validate the FieldTestPaginationEntity in Elasticsearch
        verify(mockFieldTestPaginationEntitySearchRepository, times(1)).deleteById(fieldTestPaginationEntity.getId());
    }
    ...
    public void searchFieldTestPaginationEntity() throws Exception {
        // Initialize the database
        fieldTestPaginationEntityRepository.saveAndFlush(fieldTestPaginationEntity);
        when(mockFieldTestPaginationEntitySearchRepository.search(queryStringQuery("id:" + fieldTestPaginationEntity.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(fieldTestPaginationEntity), PageRequest.of(0, 1), 1));
