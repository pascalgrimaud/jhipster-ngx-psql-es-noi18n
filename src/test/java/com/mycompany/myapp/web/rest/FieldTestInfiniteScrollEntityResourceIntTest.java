...
public class FieldTestInfiniteScrollEntityResourceIntTest {
     ...
     *
     * @see com.mycompany.myapp.repository.search.FieldTestInfiniteScrollEntitySearchRepositoryMockConfiguration
     */
    @Autowired
    private FieldTestInfiniteScrollEntitySearchRepository mockFieldTestInfiniteScrollEntitySearchRepository;
    ...
    public void setup() {
        ...
        final FieldTestInfiniteScrollEntityResource fieldTestInfiniteScrollEntityResource = new FieldTestInfiniteScrollEntityResource(fieldTestInfiniteScrollEntityRepository, mockFieldTestInfiniteScrollEntitySearchRepository);
    ...
    public void createFieldTestInfiniteScrollEntity() throws Exception {
        ...
        verify(mockFieldTestInfiniteScrollEntitySearchRepository, times(1)).save(testFieldTestInfiniteScrollEntity);
    }
    ...
    public void createFieldTestInfiniteScrollEntityWithExistingId() throws Exception {
        ...
        // Validate the FieldTestInfiniteScrollEntity in Elasticsearch
        verify(mockFieldTestInfiniteScrollEntitySearchRepository, times(0)).save(fieldTestInfiniteScrollEntity);
    }
    ...
    public void deleteFieldTestInfiniteScrollEntity() throws Exception {
        ...
        // Validate the FieldTestInfiniteScrollEntity in Elasticsearch
        verify(mockFieldTestInfiniteScrollEntitySearchRepository, times(1)).deleteById(fieldTestInfiniteScrollEntity.getId());
    }
    ...
    public void searchFieldTestInfiniteScrollEntity() throws Exception {
        // Initialize the database
        fieldTestInfiniteScrollEntityRepository.saveAndFlush(fieldTestInfiniteScrollEntity);
        when(mockFieldTestInfiniteScrollEntitySearchRepository.search(queryStringQuery("id:" + fieldTestInfiniteScrollEntity.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(fieldTestInfiniteScrollEntity), PageRequest.of(0, 1), 1));
