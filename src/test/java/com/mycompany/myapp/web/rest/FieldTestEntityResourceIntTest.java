...
public class FieldTestEntityResourceIntTest {
     ...
     *
     * @see com.mycompany.myapp.repository.search.FieldTestEntitySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final FieldTestEntityResource fieldTestEntityResource = new FieldTestEntityResource(fieldTestEntityRepository, mockFieldTestEntitySearchRepository);
    ...
    public void createFieldTestEntity() throws Exception {
        ...
        verify(mockFieldTestEntitySearchRepository, times(1)).save(testFieldTestEntity);
    }
    ...
    public void createFieldTestEntityWithExistingId() throws Exception {
        ...
        // Validate the FieldTestEntity in Elasticsearch
        verify(mockFieldTestEntitySearchRepository, times(0)).save(fieldTestEntity);
    }
    ...
    public void deleteFieldTestEntity() throws Exception {
        ...
        // Validate the FieldTestEntity in Elasticsearch
        verify(mockFieldTestEntitySearchRepository, times(1)).deleteById(fieldTestEntity.getId());
    }
    ...
    public void searchFieldTestEntity() throws Exception {
        // Initialize the database
        fieldTestEntityRepository.saveAndFlush(fieldTestEntity);
        when(mockFieldTestEntitySearchRepository.search(queryStringQuery("id:" + fieldTestEntity.getId())))
            .thenReturn(Collections.singletonList(fieldTestEntity));
