...
public class FieldTestServiceImplEntityResourceIntTest {
     ...
     *
     * @see com.mycompany.myapp.repository.search.FieldTestServiceImplEntitySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createFieldTestServiceImplEntity() throws Exception {
        ...
        verify(mockFieldTestServiceImplEntitySearchRepository, times(1)).save(testFieldTestServiceImplEntity);
    }
    ...
    public void createFieldTestServiceImplEntityWithExistingId() throws Exception {
        ...
        // Validate the FieldTestServiceImplEntity in Elasticsearch
        verify(mockFieldTestServiceImplEntitySearchRepository, times(0)).save(fieldTestServiceImplEntity);
    }
    ...
    public void updateFieldTestServiceImplEntity() throws Exception {
        ...
        reset(mockFieldTestServiceImplEntitySearchRepository);
    ...
    public void deleteFieldTestServiceImplEntity() throws Exception {
        ...
        // Validate the FieldTestServiceImplEntity in Elasticsearch
        verify(mockFieldTestServiceImplEntitySearchRepository, times(1)).deleteById(fieldTestServiceImplEntity.getId());
    }
    ...
    public void searchFieldTestServiceImplEntity() throws Exception {
        // Initialize the database
        fieldTestServiceImplEntityService.save(fieldTestServiceImplEntity);
        when(mockFieldTestServiceImplEntitySearchRepository.search(queryStringQuery("id:" + fieldTestServiceImplEntity.getId())))
            .thenReturn(Collections.singletonList(fieldTestServiceImplEntity));
