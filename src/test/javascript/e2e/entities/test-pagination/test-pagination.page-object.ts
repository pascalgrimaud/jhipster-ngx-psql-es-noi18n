...
export class TestPaginationComponentsPage {
    createButton = element(by.id('jh-create-entity'));
    deleteButtons = element.all(by.css('jhi-test-pagination div table .btn-danger'));
    title = element.all(by.css('jhi-test-pagination div h2#page-heading span')).first();
...
export class TestPaginationUpdatePage {
    pageTitle = element(by.id('jhi-test-pagination-heading'));
...
export class TestPaginationDeleteDialog {
    private dialogTitle = element(by.id('jhi-delete-testPagination-heading'));
