...
export class TestEntityComponentsPage {
    ...
    deleteButtons = element.all(by.css('jhi-test-entity-my-suffix-alt div table .btn-danger'));
    title = element.all(by.css('jhi-test-entity-my-suffix-alt div h2#page-heading span')).first();
...
export class TestEntityUpdatePage {
    pageTitle = element(by.id('jhi-test-entity-my-suffix-alt-heading'));
...
export class TestEntityDeleteDialog {
    private dialogTitle = element(by.id('jhi-delete-testEntity-heading'));
