...
export class TestServiceClassComponentsPage {
    createButton = element(by.id('jh-create-entity'));
    deleteButtons = element.all(by.css('jhi-test-service-class div table .btn-danger'));
    title = element.all(by.css('jhi-test-service-class div h2#page-heading span')).first();
...
export class TestServiceClassUpdatePage {
    pageTitle = element(by.id('jhi-test-service-class-heading'));
...
export class TestServiceClassDeleteDialog {
    private dialogTitle = element(by.id('jhi-delete-testServiceClass-heading'));
