...
export class TestOneToOneComponentsPage {
    createButton = element(by.id('jh-create-entity'));
    deleteButtons = element.all(by.css('jhi-test-one-to-one-my-suffix div table .btn-danger'));
    title = element.all(by.css('jhi-test-one-to-one-my-suffix div h2#page-heading span')).first();
...
export class TestOneToOneUpdatePage {
    pageTitle = element(by.id('jhi-test-one-to-one-my-suffix-heading'));
...
export class TestOneToOneDeleteDialog {
    private dialogTitle = element(by.id('jhi-delete-testOneToOne-heading'));
