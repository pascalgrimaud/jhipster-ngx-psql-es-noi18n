...
export class TestMapstructComponentsPage {
    createButton = element(by.id('jh-create-entity'));
    deleteButtons = element.all(by.css('jhi-test-mapstruct div table .btn-danger'));
    title = element.all(by.css('jhi-test-mapstruct div h2#page-heading span')).first();
...
export class TestMapstructUpdatePage {
    pageTitle = element(by.id('jhi-test-mapstruct-heading'));
...
export class TestMapstructDeleteDialog {
    private dialogTitle = element(by.id('jhi-delete-testMapstruct-heading'));
