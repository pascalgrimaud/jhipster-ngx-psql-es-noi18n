...
export class TestManyToManyComponentsPage {
    createButton = element(by.id('jh-create-entity'));
    deleteButtons = element.all(by.css('jhi-test-many-to-many-my-suffix div table .btn-danger'));
    title = element.all(by.css('jhi-test-many-to-many-my-suffix div h2#page-heading span')).first();
...
export class TestManyToManyUpdatePage {
    pageTitle = element(by.id('jhi-test-many-to-many-my-suffix-heading'));
...
export class TestManyToManyDeleteDialog {
    private dialogTitle = element(by.id('jhi-delete-testManyToMany-heading'));
