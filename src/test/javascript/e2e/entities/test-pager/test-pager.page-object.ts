...
export class TestPagerComponentsPage {
    createButton = element(by.id('jh-create-entity'));
    deleteButtons = element.all(by.css('jhi-test-pager div table .btn-danger'));
    title = element.all(by.css('jhi-test-pager div h2#page-heading span')).first();
...
export class TestPagerUpdatePage {
    pageTitle = element(by.id('jhi-test-pager-heading'));
...
export class TestPagerDeleteDialog {
    private dialogTitle = element(by.id('jhi-delete-testPager-heading'));
