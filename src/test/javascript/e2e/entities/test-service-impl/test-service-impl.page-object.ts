...
export class TestServiceImplComponentsPage {
    createButton = element(by.id('jh-create-entity'));
    deleteButtons = element.all(by.css('jhi-test-service-impl div table .btn-danger'));
    title = element.all(by.css('jhi-test-service-impl div h2#page-heading span')).first();
...
export class TestServiceImplUpdatePage {
    pageTitle = element(by.id('jhi-test-service-impl-heading'));
...
export class TestServiceImplDeleteDialog {
    private dialogTitle = element(by.id('jhi-delete-testServiceImpl-heading'));
