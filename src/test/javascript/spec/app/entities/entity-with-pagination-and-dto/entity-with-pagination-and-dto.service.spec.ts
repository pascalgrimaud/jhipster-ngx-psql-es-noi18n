    ...
    describe('EntityWithPaginationAndDTO Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/entity-with-pagination-and-dtos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a EntityWithPaginationAndDTO', () => {
                service.create(new EntityWithPaginationAndDTO(null)).subscribe(received => {
            ...
            it('should update a EntityWithPaginationAndDTO', () => {
                service.update(new EntityWithPaginationAndDTO(123)).subscribe(received => {
            ...
            it('should return a EntityWithPaginationAndDTO', () => {
            ...
            it('should return a list of EntityWithPaginationAndDTO', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new EntityWithPaginationAndDTO(123)]);
            });
