    ...
    describe('EntityWithServiceClassAndPagination Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/entity-with-service-class-and-paginations';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a EntityWithServiceClassAndPagination', () => {
                service.create(new EntityWithServiceClassAndPagination(null)).subscribe(received => {
            ...
            it('should update a EntityWithServiceClassAndPagination', () => {
                service.update(new EntityWithServiceClassAndPagination(123)).subscribe(received => {
            ...
            it('should return a EntityWithServiceClassAndPagination', () => {
            ...
            it('should return a list of EntityWithServiceClassAndPagination', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new EntityWithServiceClassAndPagination(123)]);
            });
