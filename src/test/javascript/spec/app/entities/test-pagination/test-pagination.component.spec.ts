...
import { TestPaginationComponent } from 'app/entities/test-pagination/test-pagination.component';
...
describe('Component Tests', () => {
    describe('TestPagination Management Component', () => {
        let comp: TestPaginationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TestPaginationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.testPaginations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
