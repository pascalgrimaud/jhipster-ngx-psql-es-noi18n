    ...
    describe('FieldTestServiceImplEntity Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/field-test-service-impl-entities';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a FieldTestServiceImplEntity', () => {
                service.create(new FieldTestServiceImplEntity(null)).subscribe(received => {
            ...
            it('should update a FieldTestServiceImplEntity', () => {
                service.update(new FieldTestServiceImplEntity(123)).subscribe(received => {
            ...
            it('should return a FieldTestServiceImplEntity', () => {
            ...
            it('should return a list of FieldTestServiceImplEntity', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new FieldTestServiceImplEntity(123)]);
            });
