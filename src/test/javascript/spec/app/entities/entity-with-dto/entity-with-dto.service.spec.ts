    ...
    describe('EntityWithDTO Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/entity-with-dtos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a EntityWithDTO', () => {
                service.create(new EntityWithDTO(null)).subscribe(received => {
            ...
            it('should update a EntityWithDTO', () => {
                service.update(new EntityWithDTO(123)).subscribe(received => {
            ...
            it('should return a EntityWithDTO', () => {
            ...
            it('should return a list of EntityWithDTO', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new EntityWithDTO(123)]);
            });
