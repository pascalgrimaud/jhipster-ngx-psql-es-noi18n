    ...
    describe('FieldTestEntity Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/field-test-entities';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a FieldTestEntity', () => {
                service.create(new FieldTestEntity(null)).subscribe(received => {
            ...
            it('should update a FieldTestEntity', () => {
                service.update(new FieldTestEntity(123)).subscribe(received => {
            ...
            it('should return a FieldTestEntity', () => {
            ...
            it('should return a list of FieldTestEntity', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new FieldTestEntity(123)]);
            });
