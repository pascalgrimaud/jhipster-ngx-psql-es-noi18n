...
import { TestInfiniteScrollComponent } from 'app/entities/test-infinite-scroll/test-infinite-scroll.component';
...
describe('Component Tests', () => {
    describe('TestInfiniteScroll Management Component', () => {
        let comp: TestInfiniteScrollComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TestInfiniteScrollComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new TestInfiniteScroll(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.testInfiniteScrolls[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
