    ...
    describe('BankAccountMySuffix Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a BankAccountMySuffix', () => {
                service.create(new BankAccountMySuffix(null)).subscribe(received => {
            ...
            it('should update a BankAccountMySuffix', () => {
                service.update(new BankAccountMySuffix(123)).subscribe(received => {
            ...
            it('should return a BankAccountMySuffix', () => {
            ...
            it('should return a list of BankAccountMySuffix', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new BankAccountMySuffix(123)]);
            });
