    ...
    describe('EntityWithServiceImplAndDTO Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/entity-with-service-impl-and-dtos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a EntityWithServiceImplAndDTO', () => {
                service.create(new EntityWithServiceImplAndDTO(null)).subscribe(received => {
            ...
            it('should update a EntityWithServiceImplAndDTO', () => {
                service.update(new EntityWithServiceImplAndDTO(123)).subscribe(received => {
            ...
            it('should return a EntityWithServiceImplAndDTO', () => {
            ...
            it('should return a list of EntityWithServiceImplAndDTO', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new EntityWithServiceImplAndDTO(123)]);
            });
