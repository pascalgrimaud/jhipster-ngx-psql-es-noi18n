    ...
    describe('FieldTestInfiniteScrollEntity Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/field-test-infinite-scroll-entities';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a FieldTestInfiniteScrollEntity', () => {
                service.create(new FieldTestInfiniteScrollEntity(null)).subscribe(received => {
            ...
            it('should update a FieldTestInfiniteScrollEntity', () => {
                service.update(new FieldTestInfiniteScrollEntity(123)).subscribe(received => {
            ...
            it('should return a FieldTestInfiniteScrollEntity', () => {
            ...
            it('should return a list of FieldTestInfiniteScrollEntity', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new FieldTestInfiniteScrollEntity(123)]);
            });
