    ...
    describe('FieldTestPaginationEntity Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/field-test-pagination-entities';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a FieldTestPaginationEntity', () => {
                service.create(new FieldTestPaginationEntity(null)).subscribe(received => {
            ...
            it('should update a FieldTestPaginationEntity', () => {
                service.update(new FieldTestPaginationEntity(123)).subscribe(received => {
            ...
            it('should return a FieldTestPaginationEntity', () => {
            ...
            it('should return a list of FieldTestPaginationEntity', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new FieldTestPaginationEntity(123)]);
            });
