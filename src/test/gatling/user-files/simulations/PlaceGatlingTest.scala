...
class PlaceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Place entity")
        ...
        .repeat(2) {
            ...
            .post("/api/places")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "numberOfSeats":null, "shortName":"SAMPLE_TEXT", "colorBackground":"SAMPLE_TEXT", "colorText":"SAMPLE_TEXT", "description":null}""")).asJSON
            .check(status.is(201))
