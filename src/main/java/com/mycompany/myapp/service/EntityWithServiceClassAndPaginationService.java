...
public class EntityWithServiceClassAndPaginationService {
    ...
    public void delete(Long id) {
        ...
        entityWithServiceClassAndPaginationSearchRepository.deleteById(id);
    }
    ...
    public Page<EntityWithServiceClassAndPagination> search(String query, Pageable pageable) {
        ...
        return entityWithServiceClassAndPaginationSearchRepository.search(queryStringQuery(query), pageable);    }
}
