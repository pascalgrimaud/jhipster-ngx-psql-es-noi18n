...
public class EntityWithServiceClassPaginationAndDTOResource {
    ...
    @Timed
    public ResponseEntity<List<EntityWithServiceClassPaginationAndDTODTO>> searchEntityWithServiceClassPaginationAndDTOS(@RequestParam String query, Pageable pageable) {
