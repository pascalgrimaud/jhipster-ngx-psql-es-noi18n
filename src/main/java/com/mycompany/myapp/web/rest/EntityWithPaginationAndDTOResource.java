...
public class EntityWithPaginationAndDTOResource {
    ...
    public ResponseEntity<Void> deleteEntityWithPaginationAndDTO(@PathVariable Long id) {
        ...
        entityWithPaginationAndDTOSearchRepository.deleteById(id);
    ...
    @Timed
    public ResponseEntity<List<EntityWithPaginationAndDTODTO>> searchEntityWithPaginationAndDTOS(@RequestParam String query, Pageable pageable) {
