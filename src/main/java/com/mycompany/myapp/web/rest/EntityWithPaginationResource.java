...
public class EntityWithPaginationResource {
    ...
    public ResponseEntity<Void> deleteEntityWithPagination(@PathVariable Long id) {
        ...
        entityWithPaginationSearchRepository.deleteById(id);
    ...
    @Timed
    public ResponseEntity<List<EntityWithPagination>> searchEntityWithPaginations(@RequestParam String query, Pageable pageable) {
