...
public class FieldTestPagerEntityResource {
    ...
    public ResponseEntity<Void> deleteFieldTestPagerEntity(@PathVariable Long id) {
        ...
        fieldTestPagerEntitySearchRepository.deleteById(id);
    ...
    @Timed
    public ResponseEntity<List<FieldTestPagerEntity>> searchFieldTestPagerEntities(@RequestParam String query, Pageable pageable) {
