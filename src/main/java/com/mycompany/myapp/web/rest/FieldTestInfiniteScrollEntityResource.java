...
public class FieldTestInfiniteScrollEntityResource {
    ...
    public ResponseEntity<Void> deleteFieldTestInfiniteScrollEntity(@PathVariable Long id) {
        ...
        fieldTestInfiniteScrollEntitySearchRepository.deleteById(id);
    ...
    @Timed
    public ResponseEntity<List<FieldTestInfiniteScrollEntity>> searchFieldTestInfiniteScrollEntities(@RequestParam String query, Pageable pageable) {
