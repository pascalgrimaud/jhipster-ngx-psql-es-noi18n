...
public class FieldTestPaginationEntityResource {
    ...
    public ResponseEntity<Void> deleteFieldTestPaginationEntity(@PathVariable Long id) {
        ...
        fieldTestPaginationEntitySearchRepository.deleteById(id);
    ...
    @Timed
    public ResponseEntity<List<FieldTestPaginationEntity>> searchFieldTestPaginationEntities(@RequestParam String query, Pageable pageable) {
