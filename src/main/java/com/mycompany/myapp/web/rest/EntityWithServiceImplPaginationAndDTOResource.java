...
public class EntityWithServiceImplPaginationAndDTOResource {
    ...
    @Timed
    public ResponseEntity<List<EntityWithServiceImplPaginationAndDTODTO>> searchEntityWithServiceImplPaginationAndDTOS(@RequestParam String query, Pageable pageable) {
